...
const AdminSideBar: React.FC = () => {
    ...
    return (
        <aside className={isCollapsed ? "hidden" : "select-none hidden lg:block z-20 flex-shrink-0 w-[260px] p-1 overflow-y-auto text-center bg-gray-800 h-full"}>
            ...
            {/* Thống kê - dashboard */}
            <Link className={`${currentPath === PATH.DASHBOARD ? 'bg-blue-600' : ''} p-2 mt-3 flex items-center rounded-md cursor-pointer hover:bg-blue-600 text-white`} href={PATH.CATEGORIES}>
