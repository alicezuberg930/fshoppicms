                                                    ...
                                                    <tr className='bg-white'>
                                                        ...
                                                        <td className='px-3 py-2 md:py-4'>
                                                            <div className='flex flex-wrap justify-start gap-1'>
                                                                <Link href={`${PATH.EDIT_PRODUCT}/${v._id}`} className='p-2 text-sm font-medium text-white transition-colors duration-150 bg-gray-600 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-700 focus:outline-none' title='Edit'>
                                                                    <MdModeEdit className='w-5 h-5' />
                                                                </Link>
                                                                <button className='flex items-center p-2 text-sm font-medium text-center text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700' title='Delete'
